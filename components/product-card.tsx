      ...
      <View style={styles.body}>
        <View style={styles.identityRow}>
          <View style={styles.produceIdentity}>
            ...
            <Text numberOfLines={2} style={[styles.name, { color: theme.text }]}>{titleCase(product.name)}</Text>
          </View>
