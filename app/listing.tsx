...
export default function Listing() {
  ...
  return <Screen><View style={styles.header}><Tap onPress={() => router.back()} style={[styles.back,{borderColor:theme.border}]}><ChevronLeft size={22} color={theme.text}/></Tap><View><Text style={[styles.eyebrow,{color:theme.primary}]}>FARM INVENTORY</Text><Text style={[styles.title,{color:theme.text}]}>Add produce listing</Text></View></View>
