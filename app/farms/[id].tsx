...
import { BadgeCheck, ChevronLeft, ChevronRight, ExternalLink, Leaf, MapPin, Navigation, PackageOpen, Plus, Star, Store, Truck } from 'lucide-react-native';
...
export default function FarmDetails() {
  ...
  const { theme, products, add } = useApp();
