...
import { BadgeCheck, ChevronLeft, ChevronRight, Leaf, MapPin, PackageOpen, Star, Store, Truck } from 'lucide-react-native';
...
type FarmData = {
  farm: { id:string; name:string; description?:string; address_text:string; city:string; state:string; offers_pickup:boolean; offers_delivery:boolean; average_rating:number; review_count:number; first_name:string; last_name:string };
...
export default function FarmDetails() {
  ...
  const rating = Number(data.farm.average_rating || 0);
